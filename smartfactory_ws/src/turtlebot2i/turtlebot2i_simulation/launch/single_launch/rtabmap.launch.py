# Launch file to set up and run RTAB-Map for TurtleBot2i simulation.
import os
...
def launch_setup(context):  
    ...
    rtabmap_slam_config = os.path.join(get_package_share_directory('turtlebot2i_simulation'), 'config','rtabmap_slam_params.yaml')   
    rtabmap_util_config = os.path.join(get_package_share_directory('turtlebot2i_simulation'), 'config','rtabmap_util_params.yaml')   
    rtabmap_viz_config = os.path.join(get_package_share_directory('turtlebot2i_simulation'), 'config','rtabmap_viz_params.yaml')  
    ...
    return [
        ...
        # Odom to Map
        Node(package='tf2_ros', name="tf_odom_to_map", executable='static_transform_publisher', output='screen',
