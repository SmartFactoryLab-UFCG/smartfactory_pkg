...
from sensor_msgs.msg import Image  # Alterado para Image em vez de CameraInfo
...
class BaslerTreeNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Image, "/basler/image_rect", self.image_callback, qos_profile)
